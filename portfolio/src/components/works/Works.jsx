    ...
    <div className="works" id="works">
      ...
      <div className="card">
        <p>
          ...
          progress so far. My name is Demetre Growette, I am a young Minnesotan
          ...
          me. In order to better myself, I chose to challenge myself
          by entering the world of coding and push to become what
          everyone else told me I couldn't.
          I've recently finished my bootcamp at U.C. Davis and persuing a career as
          ...
          creating to broaden my knowledge in coding!
        </p>
      </div>
    </div>
  );
